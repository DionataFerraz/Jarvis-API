...
interface UserRepository : JpaRepository<UserEntity, Long>{
    ...
    @Query("SELECT * FROM user_entity WHERE token_facebook = :token", nativeQuery = true)
    ...
    @Query(value = "select * from user_entity u WHERE u.name = :identity or u.email = :identity", nativeQuery = true)
