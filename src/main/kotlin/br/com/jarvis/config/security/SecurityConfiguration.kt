...
//@Configuration
//@EnableWebSecurity
//open class SecurityConfiguration(private val securityFilter: SecurityFilter) {
//
//    @Bean
...
//                    .requestMatchers(HttpMethod.POST, "/api/volume/authenticate").hasRole("APP")
//                    .requestMatchers(HttpMethod.GET, "/api/**").hasRole("APP")
//                    .requestMatchers(HttpMethod.POST, "/api/**").hasRole("APP")
