...
import br.com.jarvis.component.security.YourCustomTokenEnhancer
...
//    private val userDetailsService: CustomUserDetailsService,
    ...
    override fun configure(clients: ClientDetailsServiceConfigurer) {
        clients.inMemory()
            .withClient("524257436231028")
            .secret("a45f53d2c7b335af811797e77d50cbfb")
...
//        converter.setSigningKey("your-signing-key") // Chave secreta para assinatura do token
//        converter.accessTokenConverter = defaultAccessTokenConverter()
//        return converter
//    }
//
//    @Bean
//    open fun defaultAccessTokenConverter(): DefaultAccessTokenConverter {
